...
import { PawPrint, Calendar, CreditCard, Pill, Loader2, Plus, AlertTriangle, Clock, Heart, ArrowRight } from 'lucide-react';
...
export default function ClientDashboardPage() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const statsResponse = await authFetch('http://localhost:8000/api/dashboard/client');
